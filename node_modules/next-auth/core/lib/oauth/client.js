...
async function openidClient(options) {
  ...
  if (typeof ((_provider$httpOptions = provider.httpOptions) === null || _provider$httpOptions === void 0 ? void 0 : _provider$httpOptions.timeout) === "number") {
    _openidClient.custom.setHttpOptionsDefaults({
