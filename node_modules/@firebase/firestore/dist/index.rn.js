...
function Ft(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? bt(t) ? 4 /* ServerTimestampValue */ : Yt(t) ? 9007199254740991 /* MaxValue */ : 10 /* ObjectValue */ : U();
}
...
function Lt(t, e) {
    ...
    switch (n) {
      ...
      case 10 /* ObjectValue */ :
        return function(t, e) {
            if (t === Mt.mapValue && e === Mt.mapValue) return 0;
...
class _e {
    ...
    insert(t, e) {
        return new _e(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, me.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new _e(this.comparator, this.root.remove(t, this.comparator).copy(null, null, me.BLACK, null, null));
    }
...
class me {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : me.RED, this.left = null != s ? s : me.EMPTY, 
        this.right = null != i ? i : me.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new me(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return me.EMPTY;
 ...
 * property.
 */ function Te(t, e = null, n = [], s = [], i = null, r = null, o = null) {
    return new Ie(t, e, n, s, i, r, o);
}
...
function Re(t, e) {
    ...
    var n, s;
    return t.collectionGroup === e.collectionGroup && (!!t.path.isEqual(e.path) && (!!qe(t.startAt, e.startAt) && qe(t.endAt, e.endAt)));
}
...
/** Returns the field filters that target the given field path. */ function be(t, e) {
    return t.filters.filter((t => t instanceof Se && t.field.isEqual(e)));
}
...
/** Returns the number of segments of a perfect index for this target. */ class Se extends class {} {
    constructor(t, e, n) {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.V(t, e, n) : new De(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ke(t, n) : "in" /* IN */ === e ? new Me(t, n) : "not-in" /* NOT_IN */ === e ? new Oe(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Fe(t, n) : new Se(t, e, n);
    }
    static V(t, e, n) {
        return "in" /* IN */ === e ? new Ce(t, n) : new xe(t, n);
    }
    matches(t) {
...
/** Filter that matches on key fields within an array. */ class Ce extends Se {
    constructor(t, e) {
...
/** Filter that matches on key fields not present within an array. */ class xe extends Se {
    constructor(t, e) {
...
/** A Filter that implements the array-contains operator. */ class ke extends Se {
    constructor(t, e) {
...
/** A Filter that implements the IN operator. */ class Me extends Se {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the not-in operator. */ class Oe extends Se {
    constructor(t, e) {
...
/** A Filter that implements the array-contains-any operator. */ class Fe extends Se {
    constructor(t, e) {
...
/** Creates a new Query instance with the options provided. */ function Ge(t, e, n, s, i, r, o, u) {
    return new Ke(t, e, n, s, i, r, o, u);
}
 ...
 */ function Je(t) {
    ...
    if (null === e.D) {
        ...
        t.isKeyField() || e.D.push(new Be(t)), e.D.push(new Be(gt.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function Ye(t) {
    const e = G(t);
    if (!e.C) if ("F" /* First */ === e.limitType) e.C = Te(e.path, e.collectionGroup, Je(e), e.filters, e.limit, e.startAt, e.endAt); else {
        // Flip the orderBy directions since we want the last results
        const t = [];
        for (const n of Je(e)) {
            const e = "desc" /* DESCENDING */ === n.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            t.push(new Be(n.field, e));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                const n = e.endAt ? new $e(e.endAt.position, e.endAt.inclusive) : null, s = e.startAt ? new $e(e.startAt.position, e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
        e.C = Te(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.C;
}

function Xe(t, e, n) {
    return new Ke(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function Ze(t, e) {
    return Re(Ye(t), Ye(e)) && t.limitType === e.limitType;
}
...
function tn(t) {
    return `${Ee(Ye(t))}|lt:${t.limitType}`;
}

function en(t) {
    return `Query(target=${Ae(Ye(t))}; limitType=${t.limitType})`;
}
 ...
 */
        ...
        }(t.startAt, Je(t), e)) return !1;
        if (t.endAt && !function(t, e, n) {
            const s = Ue(t, e, n);
            return t.inclusive ? s >= 0 : s > 0;
        }(t.endAt, Je(t), e)) return !1;
        return !0;
    }
    /**
 ...
 */ function ln(t, e, n) {
    ...
    }(n, e) : t instanceof wn ? mn(t, e) : t instanceof gn ? yn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = dn(t, e), s = In(n) + In(t.k);
        return Qt(n) && Qt(t.k) ? an(s) : un(t.M, s);
    }(t, e);
}
 ...
 */ function fn(t, e, n) {
    ...
    // applications.
    return t instanceof wn ? mn(t, e) : t instanceof gn ? yn(t, e) : n;
}
 ...
 */ function dn(t, e) {
    return t instanceof pn ? Qt(n = e) || function(t) {
...
/** Transforms an array value via a remove operation. */ class gn extends hn {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function An(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof wn && e instanceof wn || t instanceof gn && e instanceof gn ? ut(t.elements, e.elements, $t) : t instanceof pn && e instanceof pn ? $t(t.k, e.k) : t instanceof _n && e instanceof _n;
 ...
 */ function vn(t, e, n) {
    t instanceof Nn ? function(t, e, n) {
        ...
        i.setAll(Mn(t)), i.setAll(s), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function Sn(t, e, n) {
    t instanceof Nn ? function(t, e, n) {
        ...
        s.setAll(i), e.convertToFoundDocument(xn(e), s).setHasLocalMutations();
    }
    /**
 ...
 *    ignored.
 */ (t, e, n) : t instanceof kn ? function(t, e, n) {
        if (!bn(t.precondition, e)) return;
        const s = Fn(t.fieldTransforms, n, e), i = e.data;
        i.setAll(Mn(t)), i.setAll(s), e.convertToFoundDocument(xn(e), i).setHasLocalMutations();
    }
    /**
...
function Cn(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && ut(t, e, ((t, e) => An(t, e)));
 ...
 */ function Fn(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, ln(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class $n extends Vn {
    constructor(t, e) {
 ...
 *     Code.UNKNOWN.
 */ (qn = Un || (Un = {}))[qn.OK = 0] = "OK", qn[qn.CANCELLED = 1] = "CANCELLED", 
qn[qn.UNKNOWN = 2] = "UNKNOWN", qn[qn.INVALID_ARGUMENT = 3] = "INVALID_ARGUMENT", 
qn[qn.DEADLINE_EXCEEDED = 4] = "DEADLINE_EXCEEDED", qn[qn.NOT_FOUND = 5] = "NOT_FOUND", 
qn[qn.ALREADY_EXISTS = 6] = "ALREADY_EXISTS", qn[qn.PERMISSION_DENIED = 7] = "PERMISSION_DENIED", 
qn[qn.UNAUTHENTICATED = 16] = "UNAUTHENTICATED", qn[qn.RESOURCE_EXHAUSTED = 8] = "RESOURCE_EXHAUSTED", 
qn[qn.FAILED_PRECONDITION = 9] = "FAILED_PRECONDITION", qn[qn.ABORTED = 10] = "ABORTED", 
qn[qn.OUT_OF_RANGE = 11] = "OUT_OF_RANGE", qn[qn.UNIMPLEMENTED = 12] = "UNIMPLEMENTED", 
qn[qn.INTERNAL = 13] = "INTERNAL", qn[qn.UNAVAILABLE = 14] = "UNAVAILABLE", qn[qn.DATA_LOSS = 15] = "DATA_LOSS";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const jn = new _e(kt.comparator);

function Wn() {
    return jn;
}

const zn = new _e(kt.comparator);
...
function Jn() {
    return new Qn((t => t.toString()), ((t, e) => t.isEqual(e)));
}

const Yn = new _e(kt.comparator);

const Xn = new ge(kt.comparator);
 ...
 */ class ns {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, ss.createSynthesizedTargetChangeForCurrentChange(t, e)), new ns(ht.min(), n, es(), Wn(), Zn());
    }
}
 ...
 */ class ss {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new ss(Tt.EMPTY_BYTE_STRING, e, Zn(), Zn(), Zn());
    }
}
...
class as {
     ...
     */    yt(t) {
        ...
        return this.it = Wn(), this.rt = cs(), this.ot = new ge(ot), s;
    }
    /**
    ...
    Tt(t) {
        let e = this.rt.get(t);
        return e || (e = new ge(ot), this.rt = this.rt.insert(t, e)), e;
    }
    /**
...
function As(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? wt.emptyPath() : Ps(e);
}
...
function Vs(t, e, n) {
    const s = Ts(t, e.name), i = gs(e.updateTime), r = new ne({
        mapValue: {
            fields: e.fields
        }
...
function vs(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Ts(t, e.found.name), s = gs(e.found.updateTime), i = new ne({
            mapValue: {
...
function Ss(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            const e = void 0 === t.code ? Q.UNKNOWN : Gn(t.code);
 ...
 */ (o);
        ...
        const i = Ts(t, s.document.name), r = gs(s.document.updateTime), o = new ne({
            mapValue: {
        ...
        s.document;
        const i = Ts(t, s.document), r = s.readTime ? gs(s.readTime) : ht.min(), o = ie.newNoDocument(i, r), u = s.removedTargetIds || [];
        n = new is([], u, o.key, o);
...
function Cs(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Pn.updateTime(gs(t.updateTime)) : void 0 !== t.exists ? Pn.exists(t.exists) : Pn.none();
    }(e.currentDocument) : Pn.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) q("REQUEST_TIME" === e.setToServerValue), n = new _n; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new wn(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new gn(t);
        } else "increment" in e ? n = new pn(t, e.increment) : U();
        const s = gt.fromServerFormat(e.fieldPath);
        return new En(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Ts(t, e.update.name), r = new ne({
            mapValue: {
...
function xs(t, e) {
    return t && t.length > 0 ? (q(void 0 !== e), t.map((t => function(t, e) {
        ...
        n = gs(e)), new Rn(n, t.transformResults || []);
    }(t, e)))) : [];
}
...
function Ms(t) {
    ...
    // visible for testing
    (n.endAt)), Ge(e, i, o, r, u, "F" /* First */ , a, c);
}
...
function Fs(t) {
    return t ? void 0 !== t.unaryFilter ? [ Ks(t) ] : void 0 !== t.fieldFilter ? [ qs(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => Fs(t))).reduce(((t, e) => t.concat(e))) : U() : [];
}
...
function qs(t) {
    return Se.create(Us(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
 ...
 */ class Ii {
    ...
    next(t, e) {
        return this.callbackAttached && U(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new Ii(((n, s) => {
            this.nextCallback = e => {
    ...
    wrapUserFunction(t) {
        try {
            const e = t();
            return e instanceof Ii ? e : Ii.resolve(e);
        } catch (t) {
            return Ii.reject(t);
        }
    }
    wrapSuccess(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Ii.resolve(e);
    }
    wrapFailure(t, e) {
        return t ? this.wrapUserFunction((() => t(e))) : Ii.reject(e);
    }
    static resolve(t) {
        return new Ii(((e, n) => {
            e(t);
     ...
     */    static or(t) {
        let e = Ii.resolve(!1);
        for (const n of t) e = e.next((t => t ? Ii.resolve(t) : n()));
        return e;
    }
    static forEach(t, e) {
        const n = [];
...
class Ti {
    constructor(t, e) {
        ...
        this.At = new W, this.transaction.oncomplete = () => {
            ...
            e.error ? this.At.reject(new Ri(t, e.error)) : this.At.resolve();
        }, this.transaction.onerror = e => {
            const n = Si(e.target.error);
            this.At.reject(new Ri(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
            return new Ti(e, t.transaction(s, n));
        } catch (t) {
            throw new Ri(e, t);
        }
    }
 ...
 */ class Ei {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Ei.Vt(h()) && $("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    ...
    /** Returns true if IndexedDB is available in the current environment. */    static vt() {
        ...
        // Check the UA string to find out the browser.
                const t = h(), e = Ei.Vt(t), n = 0 < e && e < 10, s = Ei.Dt(t), i = 0 < s && s < 4.5;
        // IE 10
     ...
     */    async Nt(t) {
        return this.db || (F("SimpleDb", "Opening database:", this.name), this.db = await new Promise(((e, n) => {
            ...
            s.onsuccess = t => {
                ...
                n(new Ri(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
            }, s.onerror = e => {
                const s = e.target.error;
                "VersionError" === s.name ? n(new j(Q.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === s.name ? n(new j(Q.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + s)) : n(new Ri(t, s));
            }, s.onupgradeneeded = t => {
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = Ti.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).next((t => (e.Pt(), 
                t))).catch((t => (
                // Abort the transaction if there was an error.
                e.abort(t), Ii.reject(t)))).toPromise();
...
/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Ri extends j {
    constructor(t, e) {
        super(Q.UNAVAILABLE, `IndexedDB transaction '${t}' failed: ${e}`), this.name = "IndexedDbTransactionError";
    }
}

/** Verifies whether `e` is an IndexedDbTransactionError. */ function Pi(t) {
    ...
    Kt(t, e) {
        ...
        return new Ii(((s, i) => {
            t.onerror = t => {
                ...
                if (!i) return void s();
                const r = new Ai(i), o = e(i.primaryKey, i.value, r);
                if (o instanceof Ii) {
                    const t = o.catch((t => (r.done(), Ii.reject(t))));
                    n.push(t);
                }
 ...
 */ class xi {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && ut(this.mutations, t.mutations, ((t, e) => Cn(t, e))) && ut(this.baseMutations, t.baseMutations, ((t, e) => Cn(t, e)));
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function Fi(t, e) {
    ...
    if (e.document) n = Vs(t.Jt, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
        const t = kt.fromSegments(e.noDocument.path), s = Ui(e.noDocument.readTime);
        n = ie.newNoDocument(t, s), e.hasCommittedMutations && n.setHasCommittedMutations();
    } else {
        if (!e.unknownDocument) return U();
        {
            const t = kt.fromSegments(e.unknownDocument.path), s = Ui(e.unknownDocument.version);
...
function qi(t, e) {
    ...
    const s = e.mutations.map((e => Cs(t.Jt, e))), i = ct.fromMillis(e.localWriteTimeMs);
    return new xi(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Ki(t) {
    const e = Ui(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? Ui(t.lastLimboFreeSnapshotVersion) : ht.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (q(1 === (i = t.query).documents.length), 
    s = Ye(Qe(As(i.documents[0])))) : s = function(t) {
        return Ye(Ms(t));
    }(t.query), new Mi(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, Tt.fromBase64String(t.resumeToken));
}
...
/** Encodes TargetData into a DbTarget for storage locally. */ function Gi(t, e) {
    ...
    let i;
    i = Pe(e.target) ? Ns(t.Jt, e.target) : ks(t.Jt, e.target);
...
function ji(t, e) {
    return new ki(e.largestBatchId, Cs(t.Jt, e.overlayMutation));
}
 ...
 */ class Yi {
    ...
    getOverlay(t, e) {
        return Xi(t).get(Wi(this.userId, e)).next((t => t ? ji(this.M, t) : null));
    }
    saveOverlays(t, e, n) {
        const s = [];
    ...
    removeOverlaysForBatchId(t, e, n) {
        ...
        return s.forEach((e => {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            i.push(Xi(t).Qt("collectionPathOverlayIndex", s));
        })), Ii.waitFor(i);
    }
    getOverlaysForCollection(t, e, n) {
        const s = Jn(), i = js(e), r = IDBKeyRange.bound([ this.userId, i, n ], [ this.userId, i, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Xi(t).qt("collectionPathOverlayIndex", r).next((t => {
            for (const e of t) {
                const t = ji(this.M, e);
                s.set(t.getKey(), t);
            }
    ...
    Xt(t, e) {
        return Xi(t).put(function(t, e, n) {
            const [s, i, r] = Wi(e, n.mutation.key);
            return {
                userId: e,
                collectionPath: i,
                documentId: r,
 ...
 */ class rr {
    constructor() {
        this.De = new nr, this.Ce = new sr(this.De), this.xe = new ir(this.De);
    }
    seed(t) {
        this.De.seed(t);
    }
...
function ur(t, e) {
    ...
    return 0 !== n ? n : (n = ar(t.arrayValue, e.arrayValue), 0 !== n ? n : (n = ar(t.directionalValue, e.directionalValue), 
 ...
 */ class hr {
    ...
    addToCollectionParentIndex(t, e) {
        return this.qe.add(e), Ii.resolve();
    }
    getCollectionParents(t, e) {
        return Ii.resolve(this.qe.getEntries(e));
    }
    addFieldIndex(t, e) {
    ...
    getDocumentsMatchingTarget(t, e) {
        // Field indices are not supported with memory persistence.
        return Ii.resolve(null);
    }
    getIndexType(t, e) {
        // Field indices are not supported with memory persistence.
        return Ii.resolve(0 /* NONE */);
    }
    getFieldIndexes(t, e) {
        // Field indices are not supported with memory persistence.
        return Ii.resolve([]);
 ...
 */ class lr {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new ge(wt.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new ge(wt.comparator)).toArray();
    }
}
...
class dr {
    constructor(t, e) {
         ...
         */
        this.Ge = new Qn((t => Ee(t)), ((t, e) => Re(t, e))), this.uid = t.uid || "";
    }
    /**
    ...
    getDocumentsMatchingTarget(t, e) {
        ...
        let s = !0;
        const i = new Map;
        return Ii.forEach(this.Qe(e), (e => this.je(t, e).next((t => {
            s && (s = !!t), i.set(e, t);
        })))).next((() => {
            if (s) {
                let t = Zn();
                const s = [];
                return Ii.forEach(i, ((i, r) => {
                    /** Returns a debug representation of the field index */
                    var o;
                    F("IndexedDbIndexManager", `Using index ${o = i, `id=${o.indexId}|cg=${o.collectionGroup}|f=${o.fields.map((t => `${t.fieldPath}:${t.kind}`)).join(",")}`} to execute ${Ee(e)}`);
 ...
 */ (r, i), a = function(t, e) {
                        const n = new Map;
                        for (const s of ue(e)) for (const e of be(t, s.fieldPath)) switch (e.op) {
                          case "==" /* EQUAL */ :
                          case "in" /* IN */ :
 ...
 */ (r, i), c = function(t, e) {
                        ...
                        // startAt.
                                                for (const i of ue(e)) {
                            const e = 0 /* ASCENDING */ === i.kind ? Ve(t, i.fieldPath, t.startAt) : ve(t, i.fieldPath, t.startAt);
 ...
 */ (r, i), h = function(t, e) {
                        ...
                        // endAt.
                                                for (const i of ue(e)) {
                            const e = 0 /* ASCENDING */ === i.kind ? ve(t, i.fieldPath, t.endAt) : Ve(t, i.fieldPath, t.endAt);
                            n.push(e.value), s && (s = e.inclusive);
                        }
                        return new $e(n, s);
                    }(r, i), l = this.We(i, r, c), f = this.We(i, r, h), d = this.ze(i, r, a), _ = this.He(i.indexId, u, l, c.inclusive, f, h.inclusive, d);
                    return Ii.forEach(_, (i => n.Gt(i, e.limit).next((e => {
                        e.forEach((e => {
     ...
     */    He(t, e, n, s, i, r, o) {
        ...
        for (let h = 0; h < u; ++h) {
            const u = e ? this.Je(e[h / a]) : fr, l = this.Ye(t, u, n[h % a], s), f = this.Xe(t, u, i[h % a], r), d = o.map((e => this.Ye(t, u, e, 
            /* inclusive= */ !0)));
    ...
    je(t, e) {
        const n = new cr(e), s = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    ...
    getIndexType(t, e) {
        ...
        return Ii.forEach(this.Qe(e), (e => this.je(t, e).next((t => {
            t ? 0 /* NONE */ !== n && t.fields.length < function(t) {
                let e = new ge(gt.comparator), n = !1;
     ...
     */    tn(t, e) {
        const n = new rr;
        return Zi.fe.Zt(Gt(this.databaseId, e), n.Ne(function(t) {
            const e = ue(t);
    ...
    en(t, e) {
        return !!t.filters.find((t => t instanceof Se && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op)));
    }
    getFieldIndexes(t, e) {
        const n = mr(t), s = gr(t);
        return (e ? n.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)) : n.qt()).next((t => {
            const e = [];
            return Ii.forEach(t, (t => s.get([ t.indexId, this.uid ]).next((n => {
                e.push(function(t, e) {
                    const n = e ? new ce(e.sequenceNumber, new fe(Ui(e.readTime), new kt(Hs(e.documentKey)), e.largestBatchId)) : ce.empty(), s = t.fields.map((([t, e]) => new ae(gt.fromServerFormat(t), e)));
    ...
    updateCollectionGroup(t, e, n) {
        const s = mr(t), i = gr(t);
        return this.rn(t).next((t => s.qt("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((e => Ii.forEach(e, (e => i.put(function(t, e, n, s) {
            return {
                indexId: t,
                uid: e.uid || "",
                sequenceNumber: n,
                readTime: Li(s.readTime),
    ...
    updateIndexEntries(t, e) {
        ...
        // here.
        const n = new Map;
        return Ii.forEach(e, ((e, s) => {
            const i = n.get(e.collectionGroup);
            return (i ? Ii.resolve(i) : this.getFieldIndexes(t, e.collectionGroup)).next((i => (n.set(e.collectionGroup, i), 
            Ii.forEach(i, (n => this.on(t, e, n).next((e => {
                const i = this.un(s, n);
                return e.isEqual(i) ? Ii.resolve() : this.an(t, s, n, e, i);
            })))))));
        }));
    }
    cn(t, e, n, s) {
    ...
    hn(t, e, n, s) {
        return wr(t).delete([ s.indexId, this.uid, s.arrayValue, s.directionalValue, this.tn(n, e.key), e.key.path.toArray() ]);
    }
    on(t, e, n) {
        const s = wr(t);
        let i = new ge(ur);
    ...
    /** Creates the index entries for the given document. */    un(t, e) {
        ...
        if (null != i) {
            ...
            if (jt(r)) for (const i of r.arrayValue.values || []) n = n.add(new or(e.indexId, t.key, this.Je(i), s));
        } else n = n.add(new or(e.indexId, t.key, fr, s));
        return n;
    }
    /**
     ...
     */    an(t, e, n, s, i) {
        ...
        return function(t, e, n, s, i) {
            ...
            for (;u || a; ) {
                ...
                t ? (s(a), a = pe(o)) : e ? (i(u), u = pe(r)) : (u = pe(r), a = pe(o));
            }
        }(s, i, ur, (
        /* onAdd= */ s => {
     ...
     */    createRange(t, e, n) {
        ...
        n = n.sort(((t, e) => ur(t, e))).filter(((t, e, n) => !e || 0 !== ur(t, n[e - 1])));
        const s = [];
        s.push(t);
        for (const i of n) {
            const n = ur(i, t), r = ur(i, e);
            if (0 === n) 
        ...
        s.push(e);
        const i = [];
        for (let t = 0; t < s.length; t += 2) i.push(IDBKeyRange.bound([ s[t].indexId, this.uid, s[t].arrayValue, s[t].directionalValue, fr, [] ], [ s[t + 1].indexId, this.uid, s[t + 1].arrayValue, s[t + 1].directionalValue, fr, [] ]));
        return i;
    }
    getMinOffset(t, e) {
        let n;
        return Ii.forEach(this.Qe(e), (e => this.je(t, e).next((t => {
            t ? (!n || de(t.indexState.offset, n) < 0) && (n = t.indexState.offset) : n = fe.min();
        })))).next((() => n));
    }
}
...
class Er {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            q("number" == typeof o);
            const u = new xi(o, e, n, s), a = function(t, e, n) {
            ...
            let h = new ge(((t, e) => ot(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
    ...
    lookupMutationBatch(t, e) {
        return Rr(t).get(e).next((t => t ? (q(t.userId === this.userId), qi(this.M, t)) : null));
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    fn(t, e) {
        return this.ln[e] ? Ii.resolve(this.ln[e]) : this.lookupMutationBatch(t, e).next((t => {
            if (t) {
                const n = t.keys();
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Rr(t).Wt({
            ...
            e.userId === this.userId && (q(e.batchId >= n), i = qi(this.M, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Rr(t).qt("userMutationsIndex", e).next((t => t.map((t => qi(this.M, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        ...
        return Pr(t).Wt({
            ...
            return Rr(t).get(a).next((t => {
                if (!t) throw U();
                q(t.userId === this.userId), i.push(qi(this.M, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = Ys(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Pr(t).Wt({
                range: r
            }, ((t, s, i) => {
    ...
    dn(t, e) {
        ...
        return e.forEach((e => {
            s.push(Rr(t).get(e).next((t => {
                if (null === t) throw U();
                q(t.userId === this.userId), n.push(qi(this.M, t));
            })));
        })), Ii.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return Ir(t.Ht, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this._n(e.batchId);
        })), Ii.forEach(n, (e => this.referenceDelegate.markPotentiallyOrphaned(t, e))))));
    }
    /**
 ...
 */ class vr {
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => Sr(t).delete(e.targetId))).next((() => this.pn(t))).next((e => (q(e.targetCount > 0), 
    ...
    pn(t) {
        return Dr(t).get("targetGlobalKey").next((t => (q(null !== t), t)));
    }
    In(t, e) {
        return Dr(t).put("targetGlobalKey", e);
    }
    Tn(t, e) {
        return Sr(t).put(Gi(this.M, e));
    }
    /**
    ...
    getTargetData(t, e) {
        ...
        const n = Ee(e), s = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]);
        let i = null;
        return Sr(t).Wt({
            range: s,
    ...
    removeMatchingKeys(t, e, n) {
        ...
        // IndexedDb.
        const s = Cr(t);
        return Ii.forEach(e, (e => {
            const i = js(e.path);
            return Ii.waitFor([ s.delete([ n, i ]), this.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }
    ...
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.Wt({
            ...
            const s = Hs(t[1]), r = new kt(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = js(e.path), s = IDBKeyRange.bound([ n ], [ at(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Cr(t).Wt({
    ...
    // PORTING NOTE: Multi-tab only.
    Et(t, e) {
        return Sr(t).get(e).next((t => t ? Ki(t) : null));
    }
}
 ...
 */ async function xr(t) {
    if (t.code !== Q.FAILED_PRECONDITION || t.message !== yi) throw t;
 ...
 */ class kr {
    constructor(t) {
        this.An = t, this.buffer = new ge(Nr), this.Rn = 0;
    }
    Pn() {
        return ++this.Rn;
    }
    bn(t) {
        ...
        if (this.buffer.size < this.An) this.buffer = this.buffer.add(e); else {
            ...
            Nr(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
    ...
    Sn(t) {
        ...
        F("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.vn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Pi(t) ? F("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await xr(t);
            }
            await this.Sn(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class Or {
    constructor(t, e) {
    ...
    collect(t, e) {
        ...
        Ii.resolve(yr)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? (F("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        yr) : this.Nn(t, e)));
    }
    getCacheSize(t) {
...
class Fr {
     ...
     */    On(t, e) {
        return function(t, e) {
            let n = !1;
            return br(t).zt((s => Ar(t, s, e).next((t => (t && (n = !0), Ii.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.Mn(t, ((r, o) => {
            if (o <= e) {
                const e = this.On(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r, ht.min()), Cr(t).delete([ 0, js(r.path) ]))));
                }));
                s.push(e);
            }
        })).next((() => Ii.waitFor(s))).next((() => n.apply(t))).next((() => i));
    }
    removeTarget(t, e) {
 ...
 */ class Br {
    constructor() {
        ...
        this.changes = new Qn((t => t.toString()), ((t, e) => t.isEqual(e))), this.changesApplied = !1;
    }
    /**
     ...
     */    getEntry(t, e) {
        ...
        return void 0 !== n ? Ii.resolve(n) : this.getFromCache(t, e);
    }
    /**
 ...
 */
        function(t, e) {
            ...
            /* collection id */ n[n.length - 2], Bi(e), 
 ...
 */ (e, n));
     ...
     */    Un(t, e) {
        let n = Wn(), s = new _e(kt.comparator);
        return this.Ln(t, e, ((t, e) => {
            const i = this.$n(t, e);
            n = n.insert(t, i), s = s.insert(t, Tr(e));
        })).next((() => ({
            documents: n,
            qn: s
        })));
    ...
    Ln(t, e, n) {
        if (e.isEmpty()) return Ii.resolve();
        let s = new ge(jr);
        e.forEach((t => s = s.add(t)));
        const i = IDBKeyRange.bound(Gr(s.first()), Gr(s.last())), r = s.getIterator();
        let o = r.getNext();
        return Kr(t).Wt({
            index: "documentKeyIndex",
            range: i
    ...
    getAllFromCollection(t, e, n) {
        const s = [ e.popLast().toArray(), e.lastSegment(), Bi(n.readTime), n.documentKey.path.isEmpty() ? "" : n.documentKey.path.lastSegment() ], i = [ e.popLast().toArray(), e.lastSegment(), [ Number.MAX_SAFE_INTEGER, Number.MAX_SAFE_INTEGER ], "" ];
        return Kr(t).qt(IDBKeyRange.bound(s, i, !0)).next((t => {
            let e = Wn();
            for (const n of t) {
    ...
    newChangeBuffer(t) {
        return new Ur(this, !!t && t.trackRemovals);
    }
    getSize(t) {
        return this.getMetadata(t).next((t => t.byteSize));
    }
    getMetadata(t) {
        return qr(t).get("remoteDocumentGlobalKey").next((t => (q(!!t), t)));
    }
    Fn(t, e) {
...
class Ur extends Br {
    ...
    constructor(t, e) {
        ...
        // this buffer.
        this.Gn = new Qn((t => t.toString()), ((t, e) => t.isEqual(e)));
    }
    applyChanges(t) {
        const e = [];
        let n = 0, s = new ge(((t, e) => ot(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.Gn.get(i);
            if (e.push(this.Kn.removeEntry(t, i, o.readTime)), r.isValidDocument()) {
                const u = $i(this.Kn.M, r);
                ...
                const n = $i(this.Kn.M, r.convertToNoDocument(ht.min()));
                e.push(this.Kn.addEntry(t, i, n));
            }
        })), s.forEach((n => {
            e.push(this.Kn.indexManager.addToCollectionParentIndex(t, n));
        })), e.push(this.Kn.updateMetadata(t, n)), Ii.waitFor(e);
    }
    getFromCache(t, e) {
 ...
 */
    ...
    Qn(t) {
        ...
        return e.qt().next((e => Ii.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.qt("userMutationsIndex", s).next((n => Ii.forEach(n, (n => {
                q(n.userId === e.userId);
                const s = qi(this.M, n);
     ...
     */    Wn(t) {
        ...
        return t.store("targetGlobal").get("targetGlobalKey").next((t => {
            ...
            return n.Wt(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? Ii.resolve() : (n => e.put({
                    targetId: 0,
                    path: js(n),
...
const Hr = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
...
class Jr {
    ...
    c, h = 13) {
        ...
        this.cs = t => Promise.resolve(), !Jr.vt()) throw new j(Q.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Fr(this, s), this.hs = e + "main", this.M = new Oi(u), 
        this.ls = new Ei(this.hs, this.ts, new Wr(this.M)), this.fs = new vr(this.referenceDelegate, this.M), 
        this.ds = function(t) {
            return new Lr(t);
        }(this.M), this._s = new zi, this.window && this.window.localStorage ? this.ws = this.window.localStorage : (this.ws = null, 
     ...
     */    start() {
        ...
        return this.gs().then((() => {
            ...
            throw new j(Q.FAILED_PRECONDITION, Hr);
     ...
     * primary lease.
     */    gs() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => Xr(t).put({
    ...
    Es(t) {
        return Yr(t).get("owner").next((t => Ii.resolve(this.bs(t))));
    }
    Vs(t) {
     ...
     */    async vs() {
        if (this.isPrimary && !this.Ss(this.us, 18e5)) {
            ...
            const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (t => {
                const e = Ci(t, "clientMetadata");
                return e.qt().next((t => {
                    const n = this.Ds(t, 18e5), s = t.filter((t => -1 === n.indexOf(t)));
                    // Delete metadata for clients that are no longer considered active.
                    return Ii.forEach(s, (t => e.delete(t.clientId))).next((() => s));
                }));
            })).catch((() => []));
     ...
     */    As(t) {
        if (this.Zn) return Ii.resolve(!0);
        return Yr(t).get("owner").next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Xr(t).qt().next((t => void 0 === this.Ds(t, 5e3).find((t => {
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Fs() {
        return this.runTransaction("getActiveClients", "readonly", (t => Xr(t).qt().next((t => this.Ds(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.ns;
    }
    getMutationQueue(t, e) {
        return Er.Yt(t, this.M, e, this.referenceDelegate);
    }
    getTargetCache() {
        return this.fs;
    }
    ...
    getIndexManager(t) {
        return new dr(t, this.M.Jt.databaseId);
    }
    getDocumentOverlayCache(t) {
        return Yi.Yt(this.M, t);
    }
    getBundleCache() {
        return this._s;
    }
    runTransaction(t, e, n) {
        ...
        const s = "readonly" === e ? "readonly" : "readwrite", i = 14 === (r = this.ts) ? gi : 13 === r ? mi : 12 === r ? wi : 11 === r ? _i : void U();
        /** Returns the object stores for the provided schema. */
        var r;
        let o;
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
                return this.ls.runTransaction(t, s, i, (s => (o = new Di(s, this.es ? this.es.next() : st.A), 
        "readwrite-primary" === e ? this.Es(o).next((t => !!t || this.As(o))).next((e => {
            ...
            this.Yn.enqueueRetryable((() => this.cs(!1))), new j(Q.FAILED_PRECONDITION, yi);
            return n(o);
    ...
    // be turned off.
    $s(t) {
        return Yr(t).get("owner").next((t => {
            if (null !== t && this.Ss(t.leaseTimestampMs, 5e3) && !this.xs(t.ownerId) && !this.bs(t) && !(this.Zn || this.allowTabSynchronization && t.allowTabSynchronization)) throw new j(Q.FAILED_PRECONDITION, Hr);
        }));
    }
    /**
 ...
 */
        return function(t) {
            return kt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.js(t, e.path) : He(e) ? this.Ws(t, e, n) : this.zs(t, e, n);
    }
    js(t, e) {
    ...
    Ws(t, e, n) {
        ...
        let i = Hn();
        return this.indexManager.getCollectionParents(t, s).next((r => Ii.forEach(r, (r => {
            const o = function(t, e) {
                return new Ke(e, 
    ...
    zs(t, e, n) {
        ...
        return this.ds.getAllFromCollection(t, e.path, n).next((n => (s = n, this.Bs.getAllMutationBatchesAffectingQuery(t, e)))).next((t => {
            for (const e of t) for (const t of e.mutations) {
                ...
                i = ie.newInvalidDocument(n), s = s.insert(n, i)), Sn(t, i, e.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        })).next((() => (
 ...
 */ class eo {
 ...
 // do nothing
        ...
        return new eo(t, e.fromCache, n, s);
    }
}
 ...
 */ class no {
     ...
     */    ei(t, e, n, s) {
        return je(e) || s.isEqual(ht.min()) ? this.ni(t, e) : this.Zs.Ks(t, n).next((i => {
            const r = this.si(e, i);
            return this.ii(e, r, n, s) ? this.ni(t, e) : (M() <= u.DEBUG && F("QueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), en(e)), 
            this.ri(t, r, e, he(s, -1)));
        }));
    ...
    ni(t, e) {
        return M() <= u.DEBUG && F("QueryEngine", "Using full collection scan to execute query:", en(e)), 
...
class so {
    ...
    li(t) {
        ...
        this.fi = new to(this.hi, this.Bs, this.indexManager), this.hi.setIndexManager(this.indexManager), 
 ...
 */ (a, c, r) && o.push(n.fs.updateTargetData(t, c));
        ...
        return Ii.waitFor(o).next((() => r.apply(t))).next((() => n.fi.Gs(t, u))).next((() => u));
    })).then((t => (n.ui = i, t)));
}
...
function lo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Ii.resolve(s)) : n.fs.allocateTargetId(t).next((i => (s = new Mi(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
 ...
 */ function _o(t, e, n) {
    ...
    return s.persistence.runTransaction("Execute query", "readonly", (t => function(t, e, n) {
        const s = G(t), i = s.ai.get(n);
        return void 0 !== i ? Ii.resolve(s.ui.get(i)) : s.fs.getTargetData(e, n);
    }(s, t, Ye(e)).next((e => {
        if (e) return i = e.lastLimboFreeSnapshotVersion, s.fs.getMatchingKeysForTargetId(t, e.targetId).next((t => {
            r = t;
        }));
    })).next((() => s.oi.Qs(t, e, n ? i : ht.min(), n ? r : Zn()))).next((t => (go(s, sn(e), t), 
    {
        documents: t,
        _i: r
    })))));
...
// PORTING NOTE: Multi-Tab only.
function wo(t, e) {
    const n = G(t), s = G(n.fs), i = n.ui.get(e);
...
// PORTING NOTE: Multi-Tab only.
function mo(t, e) {
    const n = G(t), s = n.ci.get(e) || ht.min();
    // Get the current maximum read time for the collection. This should always
    // exist, but to reduce the chance for regressions we default to
    // SnapshotVersion.Min()
    // TODO(indexing): Consider removing the default value.
        return n.persistence.runTransaction("Get new document changes", "readonly", (t => n.hi.getAllFromCollectionGroup(t, e, he(s, -1), 
    /* limit= */ Number.MAX_SAFE_INTEGER))).then((t => (go(n, e, t), t)));
}
...
async function yo(t, e, n, s) {
    ...
    const u = i.hi.newChangeBuffer({
        trackRemovals: !0
    }), a = await lo(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return Ye(Qe(wt.fromString(`__bundle__/docs/${t}`)));
    }(s));
 ...
 */
async function po(t, e, n = Zn()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = await lo(t, Ye(Qi(e.bundledQuery))), i = G(t);
 ...
 */ class Io {
    ...
    getBundleMetadata(t, e) {
        return Ii.resolve(this.yi.get(e));
    }
    saveBundleMetadata(t, e) {
    ...
    getNamedQuery(t, e) {
        return Ii.resolve(this.pi.get(e));
    }
    saveNamedQuery(t, e) {
 ...
 */ class To {
    constructor() {
        ...
        this.overlays = new _e(kt.comparator), this.Ii = new Map;
    }
    getOverlay(t, e) {
        return Ii.resolve(this.overlays.get(e));
    }
    saveOverlays(t, e, n) {
    ...
    removeOverlaysForBatchId(t, e, n) {
        ...
        this.Ii.delete(n)), Ii.resolve();
    }
    getOverlaysForCollection(t, e, n) {
        const s = Jn(), i = e.length + 1, r = new kt(e.child("")), o = this.overlays.getIteratorFrom(r);
        for (;o.hasNext(); ) {
    ...
    getOverlaysForCollectionGroup(t, e, n, s) {
        let i = new _e(((t, e) => t - e));
        const r = this.overlays.getIterator();
        for (;r.hasNext(); ) {
            const t = r.getNext().value;
            if (t.getKey().getCollectionGroup() === e && t.largestBatchId > n) {
                let e = i.get(t.largestBatchId);
                null === e && (e = Jn(), i = i.insert(t.largestBatchId, e)), e.set(t.getKey(), t);
            }
        }
        const o = Jn(), u = i.getIterator();
        for (;u.hasNext(); ) {
    ...
    Xt(t, e, n) {
        ...
        let i = this.Ii.get(e);
        void 0 === i && (i = Zn(), this.Ii.set(e, i)), this.Ii.set(e, i.add(n.key));
    }
}
 ...
 */ class Eo {
    constructor() {
        ...
        this.Ti = new ge(Ao.Ei), 
        // A set of outstanding references to a document sorted by target id.
        this.Ai = new ge(Ao.Ri);
    }
     ...
     * removed.
     */    vi(t) {
        const e = new kt(new wt([])), n = new Ao(e, t), s = new Ao(e, t + 1), i = [];
    ...
    Di(t) {
        const e = new kt(new wt([])), n = new Ao(e, t), s = new Ao(e, t + 1);
        let i = Zn();
        return this.Ai.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
    ...
    containsKey(t) {
        const e = new Ao(t, 0), n = this.Ti.firstAfterOrEqual(e);
...
class Ao {
    ...
    /** Compare by key then by ID */    static Ei(t, e) {
        return kt.comparator(t.key, e.key) || ot(t.Ci, e.Ci);
    }
    /** Compare by ID then by key */    static Ri(t, e) {
        return ot(t.Ci, e.Ci) || kt.comparator(t.key, e.key);
    }
}
 ...
 */ class Ro {
    constructor(t, e) {
        ...
        this.Ni = new ge(Ao.Ei);
    }
    checkEmpty(t) {
        return Ii.resolve(0 === this.Bs.length);
    }
    addMutationBatch(t, e, n, s) {
        const i = this.xi;
        this.xi++, this.Bs.length > 0 && this.Bs[this.Bs.length - 1];
        const r = new xi(i, e, n, s);
        this.Bs.push(r);
        // Track references by document key and index collection parents.
        for (const e of s) this.Ni = this.Ni.add(new Ao(e.key, i)), this.indexManager.addToCollectionParentIndex(t, e.key.path.popLast());
        return Ii.resolve(r);
    }
    lookupMutationBatch(t, e) {
        return Ii.resolve(this.ki(e));
    }
    getNextMutationBatchAfterBatchId(t, e) {
        const n = e + 1, s = this.Mi(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Ii.resolve(this.Bs.length > i ? this.Bs[i] : null);
    }
    getHighestUnacknowledgedBatchId() {
        return Ii.resolve(0 === this.Bs.length ? -1 : this.xi - 1);
    }
    getAllMutationBatches(t) {
        return Ii.resolve(this.Bs.slice());
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
    ...
    removeMutationBatch(t, e) {
        q(0 === this.Fi(e.batchId, "removed")), this.Bs.shift();
        let n = this.Ni;
        return Ii.forEach(e.mutations, (s => {
    ...
    containsKey(t, e) {
        const n = new Ao(e, 0), s = this.Ni.firstAfterOrEqual(n);
        return Ii.resolve(e.isEqual(s && s.key));
    }
    performConsistencyCheck(t) {
        return this.Bs.length, Ii.resolve();
    }
    /**
...
class Po {
    ...
    constructor(t) {
        ...
        this.docs = new _e(kt.comparator), 
    ...
    getEntry(t, e) {
        ...
        return Ii.resolve(n ? n.document.mutableCopy() : ie.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = Wn();
        return e.forEach((t => {
    ...
    Bi(t, e) {
        return Ii.forEach(this.docs, (t => e(t)));
    }
    newChangeBuffer(t) {
 ...
 */ class Vo {
    constructor(t) {
         ...
         * IDs.
         */
        this.qi = new Eo, this.targetCount = 0, this.Ki = Vr.gn();
    }
    forEachTarget(t, e) {
        return this.Li.forEach(((t, n) => e(n))), Ii.resolve();
    }
    getLastRemoteSnapshotVersion(t) {
        return Ii.resolve(this.lastRemoteSnapshotVersion);
    }
    getHighestSequenceNumber(t) {
        return Ii.resolve(this.Ui);
    }
    allocateTargetId(t) {
        return this.highestTargetId = this.Ki.next(), Ii.resolve(this.highestTargetId);
    }
    setTargetsMetadata(t, e, n) {
    ...
    Tn(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Ki = new Vr(e), this.highestTargetId = e), t.sequenceNumber > this.Ui && (this.Ui = t.sequenceNumber);
    }
    addTargetData(t, e) {
        return this.Tn(e), this.targetCount += 1, Ii.resolve();
    }
    updateTargetData(t, e) {
        return this.Tn(e), Ii.resolve();
    }
    removeTargetData(t, e) {
    ...
    getTargetCount(t) {
        return Ii.resolve(this.targetCount);
    }
    getTargetData(t, e) {
    ...
    addMatchingKeys(t, e, n) {
        return this.qi.Pi(e, n), Ii.resolve();
    }
    removeMatchingKeys(t, e, n) {
        this.qi.Vi(e, n);
    ...
    removeMatchingKeysForTargetId(t, e) {
        return this.qi.vi(e), Ii.resolve();
    }
    getMatchingKeysForTargetId(t, e) {
    ...
    containsKey(t, e) {
        return Ii.resolve(this.qi.containsKey(e));
    }
}
...
class vo {
     ...
     */
    constructor(t, e) {
        this.Gi = {}, this.overlays = {}, this.es = new st(0), this.ns = !1, this.ns = !0, 
        this.referenceDelegate = t(this), this.fs = new Vo(this);
        this.indexManager = new hr, this.ds = function(t) {
            return new Po(t);
        }((t => this.referenceDelegate.Qi(t))), this.M = new Oi(e), this._s = new Io(this.M);
    }
    start() {
    ...
    getMutationQueue(t, e) {
        ...
        return n || (n = new Ro(e, this.referenceDelegate), this.Gi[t.toKey()] = n), n;
    }
    getTargetCache() {
        return this.fs;
    }
...
class Do {
    ...
    addReference(t, e, n) {
        return this.Hi.addReference(n, e), this.Xi.delete(n.toString()), Ii.resolve();
    }
    removeReference(t, e, n) {
        return this.Hi.removeReference(n, e), this.Xi.add(n.toString()), Ii.resolve();
    }
    markPotentiallyOrphaned(t, e) {
        return this.Xi.add(e.toString()), Ii.resolve();
    }
    removeTarget(t, e) {
    ...
    Zi(t, e) {
        return Ii.or([ () => Ii.resolve(this.Hi.containsKey(e)), () => this.persistence.getTargetCache().containsKey(t, e), () => this.persistence.zi(t, e) ]);
    }
}
...
class ko {
     ...
     */    static tr(t, e, n) {
        ...
        r && (i = new j(s.error.code, s.error.message))), r ? new ko(t, e, s.state, i) : ($("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    er() {
        const t = {
...
class Mo {
     ...
     */    static tr(t, e) {
        ...
        i && (s = new j(n.error.code, n.error.message))), i ? new Mo(t, n.state, s) : ($("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    er() {
        const t = {
 ...
 */ class Oo {
     ...
     */    static tr(t, e) {
        ...
        return s ? new Oo(t, i) : ($("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Fo {
     ...
     */    static tr(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Fo(e.clientId, e.onlineState) : ($("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Bo {
    constructor(t, e, n, s, i) {
        ...
        this.ar = new _e(ot), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.hr = Co(this.persistenceKey, this.ir), 
        this.lr = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.ar = this.ar.insert(this.ir, new $o), this.dr = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    addLocalQueryTarget(t) {
        ...
        // by another tab
            ...
            const n = this.storage.getItem(No(this.persistenceKey, t));
            if (n) {
                const s = Mo.tr(t, n);
                s && (e = s.state);
            }
    ...
    ur(t) {
        ...
        if (e.storageArea === this.storage) {
            if (F("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.hr) return void $("Received WebStorage notification for local change. Another client might have garbage-collected our state");
 ...
 */ (e.newValue);
    ...
    Er(t, e, n) {
        const s = new ko(this.currentUser, t, e, n), i = xo(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.er());
    }
    Ar(t) {
        const e = xo(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
    }
    br(t) {
        const e = {
    ...
    Pr(t, e, n) {
        const s = No(this.persistenceKey, t), i = new Mo(t, e, n);
        this.setItem(s, i.er());
    }
    Vr(t) {
...
class Lo {
    constructor() {
        this.Ur = new $o, this.qr = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.Ur = new $o, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
...
class {
    ...
    co(t, e, n, s, i) {
        ...
        const o = {};
        return this.lo(o, s, i), this.fo(t, r, o, n).then((t => (F("RestConnection", "Received: ", t), 
        t)), (e => {
    ...
    wo(t, e, n) {
        const s = [ this.uo, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = P(), r = b(), o = {
        ...
        this.useFetchStreams && (o.xmlHttpFactory = new V({})), this.lo(o.initMessageHeaders, e, n), 
        ...
        // enough the code is exception free.
            ...
            h || (h = !0, F("Connection", "WebChannel transport closed"), l.ro());
        })), f(a, v.EventType.ERROR, (t => {
            h || (h = !0, B("Connection", "WebChannel transport errored:", t), l.ro(new j(Q.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    h = !0, l.ro(new j(e, n)), a.close();
                } else F("Connection", "WebChannel received:", n), l.oo(n);
            }
        })), f(r, S.STAT_EVENT, (t => {
...
class Ho {
     ...
     */    Ro(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && F("ExponentialBackoff", `Backing off for ${s} ms (base delay: ${this.Io} ms, delay with jitter: ${e} ms, last attempt: ${n} ms ago)`), 
...
class Jo {
    constructor(t, e, n, s, i, r, o, u) {
         ...
         * close.
         */
        this.Do = 0, this.Co = null, this.xo = null, this.stream = null, this.No = new Ho(t, e);
    }
    /**
     ...
     */    async close(t, e) {
        ...
        this.No.reset() : e && e.code === Q.RESOURCE_EXHAUSTED ? (
        // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
        $(e.toString()), $("Using maximum backoff delay to prevent overloading the backend."), 
        this.No.Ao()) : e && e.code === Q.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
     ...
     */    Go(t) {
        return e => {
            this.Yn.enqueueAndForget((() => this.Do === t ? e() : (F("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve())));
        };
    }
}
 ...
 */ class Yo extends Jo {
    ...
    onMessage(t) {
        ...
        this.No.reset();
        const e = Ss(this.M, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return ht.min();
            const e = t.targetChange;
            return e.targetIds && e.targetIds.length ? ht.min() : e.readTime ? gs(e.readTime) : ht.min();
        }(t);
     ...
     */    Ho(t) {
        const e = {};
        e.database = Rs(this.M), e.addTarget = function(t, e) {
            let n;
            const s = e.target;
            return n = Pe(s) ? {
                documents: Ns(t, s)
                ...
                query: ks(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = ws(t, e.resumeToken) : e.snapshotVersion.compareTo(ht.min()) > 0 && (
     ...
     */    Jo(t) {
        const e = {};
        e.database = Rs(this.M), e.removeTarget = t, this.Lo(e);
    }
}
 ...
 */ class Xo extends Jo {
    ...
    onMessage(t) {
        ...
        q(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Yo) {
        ...
        return q(!t.writeResults || 0 === t.writeResults.length), this.Yo = !0, this.listener.eu();
    }
    /**
...
class Zo extends class {} {
    ...
    iu() {
        if (this.su) throw new j(Q.FAILED_PRECONDITION, "The client has already been terminated.");
    }
...
class tu {
    ...
    hu(t) {
        ...
        this.uu ? ($(e), this.uu = !1) : F("OnlineStateTracker", e);
    }
    fu() {
    ...
    e, n, s, i) {
        ...
        this.mu = [], this.gu = i, this.gu.Kr((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                hu(this) && (F("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = G(t);
                    e.wu.add(4 /* ConnectivityChange */), await su(e), e.yu.set("Unknown" /* Unknown */), 
                    e.wu.delete(4 /* ConnectivityChange */), await nu(e);
                }(this));
            }));
        })), this.yu = new tu(n, s);
    }
...
async function nu(t) {
    if (hu(t)) for (const e of t.mu) await e(/* enabled= */ !0);
}
 ...
 */ function ru(t, e) {
    const n = G(t), s = vu(n);
    n._u.delete(e), s.Mo() && uu(n, e), 0 === n._u.size && (s.Mo() ? s.$o() : hu(n) && 
 ...
 */ function cu(t) {
    return hu(t) && !vu(t).ko() && t._u.size > 0;
}
...
async function _u(t, e, n) {
    ...
    t.yu.set("Online" /* Online */), e instanceof os && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await wu(t, n);
    } else if (e instanceof is ? t.pu.ut(e) : e instanceof rs ? t.pu._t(e) : t.pu.ht(e), 
    !n.isEqual(ht.min())) try {
        const e = await uo(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        ...
        F("RemoteStore", "Failed to raise snapshot:", e), await wu(t, e);
    }
}
 ...
 */ async function wu(t, e, n) {
    ...
    await su(t), t.yu.set("Offline" /* Offline */), n || (
    ...
    t.asyncQueue.enqueueRetryable((async () => {
        F("RemoteStore", "Retrying IndexedDB access"), await n(), t.wu.delete(1 /* IndexedDbFailed */), 
        await nu(t);
    }));
}
...
function Iu(t) {
    return hu(t) && !Su(t).ko() && t.du.length > 0;
}
...
async function Ru(t, e, n) {
    const s = t.du.shift(), i = Ni.from(s, e, n);
    await mu(t, (() => t.remoteSyncer.applySuccessfulWrite(i))), 
...
async function Pu(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, Kn(n) && n !== Q.ABORTED) {
            ...
            // restart.
                        Su(t).Fo(), await mu(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function bu(t, e) {
    ...
    // new mutations from the LocalStore (since mutations are per-user).
        n.wu.add(3 /* CredentialChange */), await su(n), s && 
    // Don't set the network status to Unknown if we are offline.
    n.yu.set("Unknown" /* Unknown */), await n.remoteSyncer.handleCredentialChange(e), 
    n.wu.delete(3 /* CredentialChange */), await nu(n);
}
 ...
 */ async function Vu(t, e) {
    const n = G(t);
    e ? (n.wu.delete(2 /* IsSecondary */), await nu(n)) : e || (n.wu.add(2 /* IsSecondary */), 
    await su(n), n.yu.set("Unknown" /* Unknown */));
}
 ...
 */ function vu(t) {
    ...
    t.Iu = function(t, e, n) {
        const s = G(t);
        return s.iu(), new Yo(e, s.So, s.authCredentials, s.appCheckCredentials, s.M, n);
    }
    /**
 * @license
 * Copyright 2018 Google LLC
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.Iu.Fo(), cu(t) ? au(t) : t.yu.set("Unknown" /* Unknown */)) : (await t.Iu.stop(), 
        lu(t));
    }))), t.Iu;
}
 ...
 */ function Su(t) {
    ...
    t.Tu = function(t, e, n) {
        const s = G(t);
        return s.iu(), new Xo(e, s.So, s.authCredentials, s.appCheckCredentials, s.M, n);
    }(t.datastore, t.asyncQueue, {
        Xr: Eu.bind(null, t),
        eo: Pu.bind(null, t),
        eu: Au.bind(null, t),
        ...
        await gu(t)) : (await t.Tu.stop(), t.du.length > 0 && (F("RemoteStore", `Stopping write stream with ${t.du.length} pending writes`), 
        t.du = []));
    }))), t.Tu;
}
...
class Du {
     ...
     */    static createAndSchedule(t, e, n, s, i) {
        const r = Date.now() + n, o = new Du(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
 ...
 */ function Cu(t, e) {
    if ($("AsyncQueue", `${e}: ${t}`), Pi(t)) return new j(Q.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class xu {
    ...
    constructor(t) {
        ...
        this.keyedMap = Hn(), this.sortedSet = new _e(this.comparator);
    }
    /**
     * Returns an empty copy of the existing DocumentSet, using the same
     * comparator.
     */    static emptySet(t) {
        return new xu(t.comparator);
    }
    has(t) {
...
class ku {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new ku(t, e, xu.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
...
class Ou {
    constructor() {
        this.queries = new Qn((t => tn(t)), Ze), this.onlineState = "Unknown" /* Unknown */ , 
        this.Pu = new Set;
    }
}
...
async function Fu(t, e) {
    ...
    if (r || (i = !0, r = new Mu), i) try {
        r.Ru = await n.onListen(s);
    } catch (t) {
        const n = Cu(t, `Initialization of query '${en(e.query)}' failed`);
 ...
 */ class qu {
     ...
     */    Vu(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new ku(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
    ...
    Nu(t) {
        t = ku.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Su = !0, 
        this.vu.next(t);
    }
}
 ...
 */ class Gu {
     ...
     */    mi(t) {
        return t.metadata.exists ? Vs(this.M, t.document, !1) : ie.newNoDocument(this.wi(t.metadata.name), this.gi(t.metadata.readTime));
    }
    gi(t) {
        return gs(t);
    }
 ...
 */ class Qu {
    ...
    $u(t) {
        const e = new Map, n = new Gu(this.M);
     ...
     */    async complete() {
        const t = await yo(this.localStore, new Gu(this.M), this.documents, this.Ou.id), e = this.$u(this.documents);
        for (const t of this.queries) await po(this.localStore, t, e.get(t.name));
 ...
 */ class Hu {
    ...
    e) {
        ...
        this.mutatedKeys = Zn(), this.Gu = rn(t), this.Qu = new xu(this.Gu);
    }
    /**
     ...
     */    Wu(t, e) {
        const n = e ? e.zu : new Nu, s = e ? e.Qu : this.Qu;
        ...
        if (t.inorderTraversal(((t, e) => {
            const c = s.get(t), h = nn(this.query, e) ? e : null, l = !!c && this.mutatedKeys.has(c.key), f = !!h && (h.hasLocalMutations || 
 ...
 */ (t.type, e.type) || this.Gu(t.doc, e.doc))), this.Ju(n);
        ...
        if (this.qu = o, 0 !== i.length || u) {
            return {
                snapshot: new ku(this.query, t.Qu, s, i, t.mutatedKeys, 0 /* Local */ === o, u, 
                /* excludesMetadataChanges= */ !1),
                Xu: r
            };
        }
    ...
    Yu() {
        ...
        // updating many documents.
                const t = this.Ku;
        this.Ku = Zn(), this.Qu.forEach((t => {
            this.Zu(t.key) && (this.Ku = this.Ku.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.Ku.has(t) || e.push(new zu(t));
        })), this.Ku.forEach((n => {
            t.has(n) || e.push(new Wu(n));
        })), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    ea() {
        return ku.fromInitialDocuments(this.query, this.Qu, this.mutatedKeys, 0 /* Local */ === this.qu);
    }
}
...
/** Tracks a limbo resolution. */ class Yu {
    constructor(t) {
        this.key = t, 
        /**
 ...
 */ class Xu {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.sa = {}, this.ia = new Qn((t => tn(t)), Ze), 
        this.ra = new Map, 
        /**
         ...
         * active target.
         */
        this.ua = new _e(kt.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.aa = new Map, this.ca = new Eo, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.ha = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.la = new Map, this.fa = Vr.yn(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function Zu(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.ea(); else {
        const t = await lo(n.localStore, Ye(e));
        n.isPrimaryClient && iu(n.remoteStore, t);
        const r = n.sharedClientState.addLocalQueryTarget(t.targetId);
        s = t.targetId, i = await ta(n, e, s, "current" === r);
    }
    return i;
}
 ...
 */ async function ta(t, e, n, s) {
    ...
    t._a = (e, n, s) => async function(t, e, n, s) {
        ...
        i = await _o(t.localStore, e.query, 
        /* usePreviousResults= */ !1).then((({documents: t}) => e.view.Wu(t, i))));
        const r = s && s.targetChanges.get(e.targetId), o = e.view.applyChanges(i, 
        /* updateLimboDocuments= */ t.isPrimaryClient, r);
        return da(t, e.targetId, o.Xu), o.snapshot;
    }(t, e, n, s);
    const i = await _o(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new Hu(e, i._i), o = r.Wu(i.documents), u = ss.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.applyChanges(o, 
    /* updateLimboDocuments= */ t.isPrimaryClient, u);
    da(t, n, a.Xu);
    const c = new Ju(e, n, r);
    return t.ia.set(e, c), t.ra.has(n) ? t.ra.get(n).push(e) : t.ra.set(n, [ e ]), a.snapshot;
}

/** Stops listening to the query. */ async function ea(t, e) {
    const n = G(t), s = n.ia.get(e), i = n.ra.get(s.targetId);
    if (i.length > 1) return n.ra.set(s.targetId, i.filter((t => !Ze(t, e)))), void n.ia.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.isPrimaryClient) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.sharedClientState.removeLocalQueryTarget(s.targetId);
        n.sharedClientState.isActiveQueryTarget(s.targetId) || await fo(n.localStore, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), ru(n.remoteStore, s.targetId), 
            la(n, s.targetId);
        })).catch(xr);
    } else la(n, s.targetId), await fo(n.localStore, s.targetId, 
 ...
 */ async function na(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = G(t), s = ct.now(), i = e.reduce(((t, e) => t.add(e.key)), Zn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.fi.Ks(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new kn(t.key, e, se(e.value.mapValue), Pn.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await ma(s, t.changes), await gu(s.remoteStore);
    } catch (t) {
        // If we can't persist the mutation, we reject the user callback and
        // don't send the mutation. The user can then retry the write.
        const e = Cu(t, "Failed to persist write");
        n.reject(e);
    }
}
 ...
 */ async function sa(t, e) {
    ...
    try {
        ...
        // Update `receivedDocument` as appropriate for any limbo targets.
            ...
            t.addedDocuments.size > 0 ? s.na = !0 : t.modifiedDocuments.size > 0 ? q(s.na) : t.removedDocuments.size > 0 && (q(s.na), 
            s.na = !1));
        })), await ma(n, t, e);
    } catch (t) {
        await xr(t);
 ...
 */ async function ra(t, e, n) {
    ...
    if (r) {
        ...
        let t = new _e(kt.comparator);
        // TODO(b/217189216): This limbo document should ideally have a read time,
        // so that it is picked up by any read-time based scans. The backend,
        // however, does not send a read time for target removals.
                t = t.insert(r, ie.newNoDocument(r, ht.min()));
        const n = Zn().add(r), i = new ns(ht.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new ge(ot), t, n);
        await sa(s, i), 
        ...
        s.ua = s.ua.remove(r), s.aa.delete(e), wa(s);
    } else await fo(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => la(s, e, n))).catch(xr);
}
...
async function oa(t, e) {
    ...
    try {
        ...
        // before listen events.
                ha(n, s, /*error=*/ null), ca(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await ma(n, t);
    } catch (t) {
        await xr(t);
    }
    ...
    try {
        const t = await function(t, e) {
            ...
            return n.persistence.runTransaction("Reject batch", "readwrite-primary", (t => {
                let s;
                return n.Bs.lookupMutationBatch(t, e).next((e => (q(null !== e), s = e.keys(), n.Bs.removeMutationBatch(t, e)))).next((() => n.Bs.performConsistencyCheck(t))).next((() => n.fi.Ks(t, s)));
            }));
        }
        /**
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                ha(s, e, n), ca(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await ma(s, t);
    } catch (n) {
        await xr(n);
    }
 ...
 */ async function aa(t, e) {
    const n = G(t);
    hu(n.remoteStore) || F("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
        ...
        const n = Cu(t, "Initialization of waitForPendingWrites() operation failed");
        e.reject(n);
    }
}
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function ha(t, e, n) {
    const s = G(t);
...
function fa(t, e) {
    ...
    const n = t.ua.get(e);
    null !== n && (ru(t.remoteStore, n), t.ua = t.ua.remove(e), t.aa.delete(n), wa(t));
}

function da(t, e, n) {
    for (const s of n) if (s instanceof Wu) t.ca.addReference(s.key, e), _a(t, s); else if (s instanceof zu) {
        F("SyncEngine", "Document no longer in limbo: " + s.key), t.ca.removeReference(s.key, e);
...
function _a(t, e) {
    ...
    t.ua.get(n) || t.oa.has(s) || (F("SyncEngine", "New document in limbo: " + n), t.oa.add(s), 
    wa(t));
}
 ...
 */ function wa(t) {
    for (;t.oa.size > 0 && t.ua.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.oa.delete(e);
        const n = new kt(wt.fromString(e)), s = t.fa.next();
        t.aa.set(s, new Yu(n)), t.ua = t.ua.insert(n, s), iu(t.remoteStore, new Mi(Ye(Qe(n.path)), s, 2 /* LimboResolution */ , st.A));
    }
}
...
async function ma(t, e, n) {
    ...
    s.ia.isEmpty() || (s.ia.forEach(((t, u) => {
        ...
        const n = G(t);
        try {
            await n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (t => Ii.forEach(e, (e => Ii.forEach(e.Hs, (s => n.persistence.referenceDelegate.addReference(t, e.targetId, s))).next((() => Ii.forEach(e.Js, (s => n.persistence.referenceDelegate.removeReference(t, e.targetId, s)))))))));
        } catch (t) {
            if (!Pi(t)) throw t;
...
async function ga(t, e) {
    ...
    if (!n.currentUser.isEqual(e)) {
        ...
        n.sharedClientState.handleUserChange(e, t.removedBatchIds, t.addedBatchIds), await ma(n, t.di);
    }
}

function ya(t, e) {
    const n = G(t), s = n.aa.get(e);
    if (s && s.na) return Zn().add(s.key);
    {
        let t = Zn();
        const s = n.ra.get(e);
        if (!s) return t;
 ...
 */ async function pa(t, e) {
    const n = G(t), s = await _o(n.localStore, e.query, 
    /* usePreviousResults= */ !0), i = e.view.ta(s);
    return n.isPrimaryClient && da(n, e.targetId, i.Xu), i;
}
...
async function Ia(t, e) {
    const n = G(t);
    return mo(n.localStore, e).then((t => ma(n, t)));
}
...
async function Ta(t, e, n, s) {
    const i = G(t), r = await function(t, e) {
        ...
        return n.persistence.runTransaction("Lookup mutation documents", "readonly", (t => s.fn(t, e).next((e => e ? n.fi.Ks(t, e) : Ii.resolve(null)))));
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e);
    null !== r ? ("pending" === n ? 
    ...
    await gu(i.remoteStore) : "acknowledged" === n || "rejected" === n ? (
    // NOTE: Both these methods are no-ops for batches that originated from
    // other clients.
    ha(i, e, s || null), ca(i, e), function(t, e) {
        G(G(t).Bs)._n(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : U(), await ma(i, r)) : 
...
async function Ea(t, e) {
    ...
    if (va(n), Sa(n), !0 === e && !0 !== n.da) {
        ...
        const t = n.sharedClientState.getAllActiveQueryTargets(), e = await Aa(n, t.toArray());
        n.da = !0, await Vu(n.remoteStore, !0);
        for (const t of e) iu(n.remoteStore, t);
    } else if (!1 === e && !1 !== n.da) {
        const t = [];
        let e = Promise.resolve();
        n.ra.forEach(((s, i) => {
            n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then((() => (la(n, i), 
            fo(n.localStore, i, 
            /*keepPersistedTargetData=*/ !0)))), ru(n.remoteStore, i);
        ...
        function(t) {
            ...
            e.aa.forEach(((t, n) => {
                ru(e.remoteStore, n);
            })), e.ca.Si(), e.aa = new Map, e.ua = new _e(kt.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.da = !1, await Vu(n.remoteStore, !1);
    }
}
...
async function Aa(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await lo(s.localStore, Ye(n[0]));
            for (const t of n) {
                const e = s.ia.get(t), n = await pa(s, e);
                n.snapshot && r.push(n.snapshot);
            }
        } else {
            // For queries that never executed on this client, we need to
            // allocate the target in LocalStore and initialize a new View.
            const n = await wo(s.localStore, t);
            e = await lo(s.localStore, n), await ta(s, Ra(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
async function ba(t, e, n, s) {
    ...
    if (r && r.length > 0) switch (n) {
      ...
      case "not-current":
        {
            const t = await mo(i.localStore, sn(r[0])), s = ns.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await ma(i, t, s);
            break;
        }

      case "rejected":
        await fo(i.localStore, e, 
        /* keepPersistedTargetData */ !0), la(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Va(t, e, n) {
    ...
    if (s.da) {
        for (const t of e) {
            ...
            const e = await wo(s.localStore, t), n = await lo(s.localStore, e);
            await ta(s, Ra(e), n.targetId, 
            /*current=*/ !1), iu(s.remoteStore, n);
        }
        for (const t of n) 
        ...
        await fo(s.localStore, t, 
        /* keepPersistedTargetData */ !1).then((() => {
            ru(s.remoteStore, t), la(s, t);
        })).catch(xr);
    }
}
...
function va(t) {
    const e = G(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = sa.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = ya.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = ra.bind(null, e), e.sa.zo = Bu.bind(null, e.eventManager), 
    e.sa.wa = Lu.bind(null, e.eventManager), e;
}
...
class Ca {
    ...
    async initialize(t) {
        this.M = zo(t.databaseInfo.databaseId), this.sharedClientState = this.ga(t), this.persistence = this.ya(t), 
    ...
    Ia(t) {
        return io(this.persistence, new no, t.initialUser, this.M);
    }
    ya(t) {
        return new vo(Do.Yi, this.M);
    }
    ga(t) {
        return new Lo;
    }
 ...
 */ class xa extends Ca {
    ...
    async initialize(t) {
        ...
        await Sa(this.Ta.syncEngine), await gu(this.Ta.remoteStore), 
    ...
    ya(t) {
        const e = Zr(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? pr.withCacheSize(this.cacheSizeBytes) : pr.DEFAULT;
        return new Jr(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, jo(), Wo(), this.M, this.sharedClientState, !!this.forceOwnership);
    }
    ga(t) {
        return new Lo;
    }
 ...
 */ class Na extends xa {
    ...
    async initialize(t) {
        ...
        await this.persistence.Ts((async t => {
            await Ea(this.Ta.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    ga(t) {
        const e = jo();
        if (!Bo.vt(e)) throw new j(Q.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
 ...
 */ class ka {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => ia(this.syncEngine, t, 1 /* SharedClientState */), 
    ...
    createDatastore(t) {
        const e = zo(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Qo(s));
        var s;
    ...
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => ia(this.syncEngine, t, 0 /* RemoteStore */), 
        r = qo.vt() ? new qo : new Uo, new eu(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = G(t);
            F("RemoteStore", "RemoteStore shutting down."), e.wu.add(5 /* Shutdown */), await su(e), 
            e.gu.shutdown(), 
 ...
 */ class Fa {
     ...
     */    async ba() {
        ...
        return new Ku(JSON.parse(s), t.length + n);
    }
...
class $a {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = G(t), s = Rs(n.M) + "/documents", i = {
                documents: e.map((t => Is(n.M, t)))
    ...
    delete(t) {
        this.write(new $n(t, this.precondition(t))), this.writtenDocs.add(t.toString());
    }
    async commit() {
        ...
        t.forEach(((t, e) => {
            ...
            this.mutations.push(new Bn(n, this.precondition(n)));
        })), await async function(t, e) {
            const n = G(t), s = Rs(n.M) + "/documents", i = {
                writes: e.map((t => Ds(n.M, t)))
            };
     ...
     */    precondition(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? Pn.updateTime(e) : Pn.none();
    }
    /**
 ...
 */ class Ba {
    constructor(t, e, n, s, i) {
        ...
        this.deferred = i, this.xa = n.maxAttempts, this.No = new Ho(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    Na() {
        this.No.Ro((async () => {
            const t = new $a(this.datastore), e = this.ka(t);
            e && e.then((e => {
    ...
    terminate() {
        ...
        return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async () => {
            try {
                ...
                const n = Cu(e, "Failed to shutdown persistence");
                t.reject(n);
            }
        })), t.promise;
    }
...
async function Ka(t) {
    ...
    await Ua(t, new Ca)), t.offlineComponents;
}

async function Ga(t) {
    return t.onlineComponents || (F("FirestoreClient", "Using default OnlineComponentProvider"), 
    await qa(t, new ka)), t.onlineComponents;
}

function Qa(t) {
    return Ka(t).then((t => t.persistence));
}

function ja(t) {
    return Ka(t).then((t => t.localStore));
}
...
async function Ha(t) {
    ...
    return n.onListen = Zu.bind(null, e.syncEngine), n.onUnlisten = ea.bind(null, e.syncEngine), 
    n;
}

/** Enables the network connection and re-enqueues all pending operations. */ function Ja(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Qa(t), n = await Wa(t);
        return e.setNetworkEnabled(!0), function(t) {
            const e = G(t);
            return e.wu.delete(0 /* UserDisabled */), nu(e);
        }(n);
    }));
}

/** Disables the network connection. Pending operations will not complete. */ function Ya(t) {
    return t.asyncQueue.enqueue((async () => {
        const e = await Qa(t), n = await Wa(t);
        return e.setNetworkEnabled(!1), async function(t) {
            const e = G(t);
            e.wu.add(0 /* UserDisabled */), await su(e), 
 ...
 */ function Xa(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            const s = Cu(t, `Failed to get document '${e} from cache`);
            n.reject(s);
        }
    }
    /**
...
function Za(t, e, n = {}) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Oa({
            ...
            error: t => i.reject(t)
        }), o = new qu(Qe(n.path), r, {
            includeMetadataChanges: !0,
            ku: !0
        });
        return Fu(t, o);
    }(await Ha(t), t.asyncQueue, e, n, s))), s.promise;
}
...
function tc(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            /* usePreviousResults= */ !0), i = new Hu(e, s._i), r = i.Wu(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
            n.resolve(o.snapshot);
        } catch (t) {
            const s = Cu(t, `Failed to execute query '${e} against cache`);
            n.reject(s);
        }
    }
    /**
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Oa({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => $u(t, o))), n.fromCache && "server" === s.source ? i.reject(new j(Q.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new qu(n, r, {
            includeMetadataChanges: !0,
 ...
 */ function sc(t, e, n) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => {
        ...
        new Ba(t.asyncQueue, i, n, e, s).run();
    })), s.promise;
}
...
class _c {
    constructor(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, ac("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    isEqual(t) {
 ...
 */ class wc {
    ...
    constructor(t, e, n) {
         ...
         */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new _c({}), 
 ...
 */ (t));
    ...
    _setSettings(t) {
        ...
        this._settings = new _c(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new H;
            switch (t.type) {
              case "gapi":
                const e = t.client;
 ...
 */
        return function(t) {
            const e = oc.get(t);
            e && (F("ComponentProvider", "Removing Datastore"), oc.delete(t), e.terminate());
...
function mc(t, e, n, s = {}) {
    var i;
    const r = (t = fc(t, wc))._getSettings();
 ...
 */ class gc {
     ...
     */    get parent() {
        return new pc(this.firestore, this.converter, this._key.path.popLast());
    }
    withConverter(t) {
        return new gc(this.firestore, t, this._key);
    }
}
 ...
 */ class yc {
    ...
    withConverter(t) {
        return new yc(this.firestore, t, this._query);
    }
}
 ...
 */ class pc extends yc {
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new gc(this.firestore, 
        /* converter= */ null, new kt(t));
    }
    withConverter(t) {
        return new pc(this.firestore, t, this._path);
    }
}

function Ic(t, e, ...n) {
    if (t = I(t), uc("collection", "path", e), t instanceof wc) {
        const s = wt.fromString(e, ...n);
        return hc(s), new pc(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof gc || t instanceof pc)) throw new j(Q.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(wt.fromString(e, ...n));
        return hc(s), new pc(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function Tc(t, e) {
    if (t = fc(t, wc), uc("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new j(Q.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new yc(t, 
    /* converter= */ null, 
    /**
...
function Ec(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = rt.R()), uc("doc", "path", e), t instanceof wc) {
        const s = wt.fromString(e, ...n);
        return cc(s), new gc(t, 
        /* converter= */ null, new kt(s));
    }
    {
        if (!(t instanceof gc || t instanceof pc)) throw new j(Q.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(wt.fromString(e, ...n));
        return cc(s), new gc(t.firestore, t instanceof pc ? t.converter : null, new kt(s));
    }
}
 ...
 * Firestore database.
 */ function Ac(t, e) {
    return t = I(t), e = I(e), (t instanceof gc || t instanceof pc) && (e instanceof gc || e instanceof pc) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Rc(t, e) {
    return t = I(t), e = I(e), t instanceof yc && e instanceof yc && (t.firestore === e.firestore && Ze(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Pc {
    constructor() {
        ...
        this.No = new Ho(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Qa = () => {
            const t = Wo();
            t && F("AsyncQueue", "Visibility state changed to " + t.visibilityState), this.No.bo();
        };
        const t = Wo();
 ...
 */ (t);
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = Du.createAndSchedule(this, t, e, n, (t => this.Ha(t)));
...
class Sc extends wc {
    ...
    constructor(t, e, n) {
         ...
         */
        this.type = "firestore", this._queue = new Pc, this._persistenceKey = "name" in t ? t.name : "[DEFAULT]";
    }
    _terminate() {
...
function Nc(t) {
    ...
    t._firestoreClient = new La(t._authCredentials, t._appCheckCredentials, t._queue, s);
}
 ...
 */ function kc(t, e) {
    Gc(t = fc(t, Sc));
    const n = xc(t), s = t._freezeSettings(), i = new ka;
    return Oc(n, i, new xa(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Mc(t) {
    Gc(t = fc(t, Sc));
    const e = xc(t), n = t._freezeSettings(), s = new ka;
    return Oc(e, s, new Na(s, n.cacheSizeBytes));
}
 ...
 */ function Oc(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await Ua(t, n), await qa(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function Fc(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Ei.vt()) return Promise.resolve();
                const e = t + "main";
                await Ei.delete(e);
 ...
 */ function $c(t) {
    return function(t) {
        const e = new W;
        return t.asyncQueue.enqueueAndForget((async () => aa(await za(t), e))), e.promise;
    }(xc(t = fc(t, Sc)));
}
 ...
 */ function qc(t, e) {
    const n = xc(t = fc(t, Sc)), s = new Vc;
    return ic(n, t._databaseId, e, s), s;
}
 ...
 */ function Kc(t, e) {
    return rc(xc(t = fc(t, Sc)), e).then((e => e ? new yc(t, null, e.query) : null));
}
 ...
 */ class Wc {
     ...
     */    static fromBase64String(t) {
        try {
            return new Wc(Tt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Wc(Tt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class Yc {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new kn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new Nn(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class Xc {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class th {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    nc(t) {
        return new th(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.M, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    sc(t) {
        var e;
    ...
    ac(t) {
        return Ih(t, this.settings.methodName, this.settings.cc || !1, this.path, this.settings.hc);
    }
    ...
    rc(t) {
        ...
        if (Zc(this.ec) && Jc.test(t)) throw this.ac('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class eh {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || zo(t);
    }
...
/** Parse document data from a set() call. */ function sh(t, e, n, s, i, r = {}) {
    const o = t.lc(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    mh("Data must be an object, but it was:", o, s);
    const u = _h(s, o);
    let a, c;
...
class uh extends zc {
    ...
    _toFieldTransform(t) {
        const e = rh(this, t, 
        /*array=*/ !0), n = this.fc.map((t => dh(t, e))), s = new wn(n);
...
class ah extends zc {
    ...
    _toFieldTransform(t) {
        const e = rh(this, t, 
        /*array=*/ !0), n = this.fc.map((t => dh(t, e))), s = new gn(n);
        return new En(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ch extends zc {
    ...
    _toFieldTransform(t) {
        const e = new pn(t.M, cn(t.M, this.dc));
...
/** Parse update data from an update() call. */ function hh(t, e, n, s) {
    ...
    mh("Data must be an object, but it was:", i, s);
    const r = [], o = ne.empty();
    ft(s, ((t, s) => {
        const u = ph(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function lh(t, e, n, s, i, r) {
    ...
    for (let t = 0; t < r.length; t += 2) u.push(gh(e, r[t])), a.push(r[t + 1]);
    const c = [], h = ne.empty();
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = u.length - 1; t >= 0; --t) if (!Th(c, u[t])) {
        const e = u[t];
        let n = a[t];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
    ...
    const l = new yt(c);
    return new Xc(h, l, o.fieldTransforms);
}
 ...
 */ function fh(t, e, n, s = !1) {
    return dh(n, t.lc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function dh(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return mh("Unsupported field value:", e, t), _h(t, e);
    if (t instanceof zc) 
 ...
 */
    return function(t, e) {
        ...
        if (!Zc(e.ec)) throw e.ac(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof Wc) return {
            bytesValue: ws(e.M, t._byteString)
        };
        if (t instanceof gc) {
        ...
        throw e.ac(`Unsupported field value: ${lc(t)}`);
    }
    /**
...
function wh(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ct || t instanceof Hc || t instanceof Wc || t instanceof gc || t instanceof zc);
}
 ...
 * evaluated.
 */ function ph(t, e, n) {
    if (e.search(yh) >= 0) throw Ih(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
...
/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */ function Th(t, e) {
 ...
 */ class Eh {
     ...
     */    get ref() {
        return new gc(this._firestore, this._converter, this._key);
    }
    /**
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new Ah(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Rh("DocumentSnapshot.get", t));
 ...
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Rh(t, e) {
    return "string" == typeof e ? ph(t, e) : e instanceof Qc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class bh extends Eh {
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(Rh("DocumentSnapshot.get", t));
 ...
 */ class vh {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new Ph(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new Vh(this._firestore, this._userDataWriter, n.key, n, new Ph(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new Vh(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Ph(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new Vh(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Ph(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
...
class kh extends xh {
    ...
    _apply(t) {
        const e = nh(t.firestore), n = function(t, e, n, s, i, r, o) {
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || Hh(o, r), 
            u = fh(n, e, o, 
            /* allowArrays= */ "in" /* IN */ === r || "not-in" /* NOT_IN */ === r);
            const a = Se.create(i, r, u);
            return function(t, e) {
                if (e.S()) {
                    const n = ze(t);
 ...
 */
        ...
        return new yc(t.firestore, t.converter, function(t, e) {
            const n = t.filters.concat([ e ]);
            return new Ke(t.path, t.collectionGroup, t.explicitOrderBy.slice(), n, t.limit, t.limitType, t.startAt, t.endAt);
        }(t._query, n));
    }
}
 ...
 */ (t._query, this._c, this.gc);
        return new yc(t.firestore, t.converter, function(t, e) {
            ...
            return new Ke(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.limitType, t.startAt, t.endAt);
        }(t._query, e));
    }
}
...
class $h extends xh {
    ...
    _apply(t) {
        return new yc(t.firestore, t.converter, Xe(t._query, this.yc, this.Ic));
    }
}
 ...
 * @returns The created {@link Query}.
 */ function Bh(t) {
    return dc("limit", t), new $h("limit", t, "F" /* First */);
}
 ...
 * @returns The created {@link Query}.
 */ function Lh(t) {
    return dc("limitToLast", t), new $h("limitToLast", t, "L" /* Last */);
}
...
class Uh extends xh {
    ...
    _apply(t) {
        const e = Wh(t, this.type, this.Tc, this.Ec);
        return new yc(t.firestore, t.converter, function(t, e) {
            return new Ke(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, e, t.endAt);
        }(t._query, e));
    }
}

function qh(...t) {
    return new Uh("startAt", t, 
    /*inclusive=*/ !0);
}

function Kh(...t) {
    return new Uh("startAfter", t, 
    /*inclusive=*/ !1);
}
...
class Gh extends xh {
    ...
    _apply(t) {
        const e = Wh(t, this.type, this.Tc, this.Ec);
        return new yc(t.firestore, t.converter, function(t, e) {
            return new Ke(t.path, t.collectionGroup, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, e);
        }(t._query, e));
    }
}

function Qh(...t) {
    return new Gh("endBefore", t, 
    /*inclusive=*/ !1);
}

function jh(...t) {
    return new Gh("endAt", t, /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function Wh(t, e, n, s) {
    if (n[0] = I(n[0]), n[0] instanceof Eh) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of Je(t)) if (n.field.isKeyField()) r.push(Gt(e, s.key)); else {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!He(t) && -1 !== a.indexOf("/")) throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
...
function zh(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!He(e) && -1 !== n.indexOf("/")) throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
    ...
    if (n instanceof gc) return Gt(t, n._key);
    throw new j(Q.INVALID_ARGUMENT, `Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${lc(n)}.`);
}
...
class Xh {
    ...
    convertGeoPoint(t) {
        return new Hc(Rt(t.latitude), Rt(t.longitude));
    }
    convertArray(t, e) {
 ...
 */ class el {
    ...
    set(t, e, n) {
        ...
        const s = nl(t, this._firestore), i = Zh(s.converter, e, n), r = sh(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, Pn.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = I(e)) || e instanceof Qc ? lh(this._dataReader, "WriteBatch.update", i._key, e, n, s) : hh(this._dataReader, "WriteBatch.update", i._key, e), 
        this._mutations.push(r.toMutation(i._key, Pn.exists(!0))), this;
    }
    /**
     ...
     */    delete(t) {
        ...
        return this._mutations = this._mutations.concat(new $n(e._key, Pn.none())), this;
    }
    /**
...
function sl(t) {
    t = fc(t, gc);
    const e = fc(t.firestore, Sc);
    return Za(xc(e), t._key).then((n => gl(e, t, n)));
}
 ...
 */ function rl(t) {
    t = fc(t, gc);
    const e = fc(t.firestore, Sc), n = xc(e), s = new il(e);
    return Xa(n, t._key).then((n => new bh(e, s, t._key, n, new Ph(null !== n && n.hasLocalMutations, 
 ...
 */ function ul(t) {
    t = fc(t, yc);
    const e = fc(t.firestore, Sc), n = xc(e), s = new il(e);
    return Ch(t._query), ec(n, t._query).then((n => new vh(e, s, t, n)));
}
 ...
 */ function al(t) {
    t = fc(t, yc);
    const e = fc(t.firestore, Sc), n = xc(e), s = new il(e);
    return tc(n, t._query).then((n => new vh(e, s, t, n)));
}
...
function hl(t, e, n) {
    t = fc(t, gc);
    const s = fc(t.firestore, Sc), i = Zh(t.converter, e, n);
    return ml(s, [ sh(nh(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, Pn.none()) ]);
}

function ll(t, e, n, ...s) {
    t = fc(t, gc);
    const i = fc(t.firestore, Sc), r = nh(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Qc ? lh(r, "updateDoc", t._key, e, n, s) : hh(r, "updateDoc", t._key, e);
    return ml(i, [ o.toMutation(t._key, Pn.exists(!0)) ]);
}
 ...
 */ function fl(t) {
    return ml(fc(t.firestore, Sc), [ new $n(t._key, Pn.none()) ]);
}
 ...
 */ function dl(t, e) {
    const n = fc(t.firestore, Sc), s = Ec(t), i = Zh(t.converter, e);
    return ml(n, [ sh(nh(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, Pn.exists(!1)) ]).then((() => s));
}
...
function _l(t, ...e) {
    ...
    let a, c, h;
    if (t instanceof gc) c = fc(t.firestore, Sc), h = Qe(t._key.path), a = {
        next: n => {
            e[o] && e[o](gl(c, t, n));
        },
        error: e[o + 1],
        ...
        const n = fc(t, yc);
        c = fc(n.firestore, Sc), h = n._query;
        const s = new il(c);
        a = {
            next: t => {
    ...
    return function(t, e, n, s) {
        const i = new Oa(s), r = new qu(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => Fu(await Ha(t), r))), () => {
            i.Aa(), t.asyncQueue.enqueueAndForget((async () => $u(await Ha(t), r)));
        };
    }(xc(c), h, u, a);
}

function wl(t, e) {
    return nc(xc(t = fc(t, Sc)), bc(e) ? e : {
        next: e
    });
}
 ...
 */ function ml(t, e) {
    return function(t, e) {
        const n = new W;
        return t.asyncQueue.enqueueAndForget((async () => na(await za(t), e, n))), n.promise;
    }(xc(t), e);
}
 ...
 */ function gl(t, e, n) {
    ...
    return new bh(t, i, e._key, s, new Ph(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class yl extends class {
     ...
     */    get(t) {
        ...
        return this._transaction.lookup([ e._key ]).then((t => {
            ...
            const s = t[0];
            if (s.isFoundDocument()) return new Eh(this._firestore, n, s.key, s, e.converter);
            if (s.isNoDocument()) return new Eh(this._firestore, n, e._key, null, e.converter);
            throw U();
        }));
    }
    set(t, e, n) {
        const s = nl(t, this._firestore), i = Zh(s.converter, e, n), r = sh(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = I(e)) || e instanceof Qc ? lh(this._dataReader, "Transaction.update", i._key, e, n, s) : hh(this._dataReader, "Transaction.update", i._key, e), 
     ...
     */    get(t) {
        ...
        return super.get(t).then((t => new bh(this._firestore, n, e._key, t._document, new Ph(
        /* hasPendingWrites= */ !1, 
 ...
 * writes.
 */ function Pl(t) {
    return xc(t = fc(t, Sc)), new el(t, (e => ml(t, e)));
}
 ...
 */ function bl(t, e) {
    ...
    if (Array.isArray(n.indexes)) for (const t of n.indexes) {
        ...
        if (Array.isArray(t.fields)) for (const e of t.fields) {
            const t = ph("setIndexConfiguration", Vl(e, "fieldPath"));
 ...
 */ !function(t, e = !0) {
    !function(t) {
        ...
        const s = t.getProvider("app").getImmediate(), i = new Sc(s, new Y(t.getProvider("auth-internal")), new et(t.getProvider("app-check-internal")));
